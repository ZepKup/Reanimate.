...
wait()
  		game:GetService("Workspace").CloneCharacter.AlignPosition.Name = "AlignPosition"
  		game:GetService("Workspace").CloneCharacter.AlignOrientation.Name = "AlignOrientation"
