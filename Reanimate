...
spawn(function()
	...
	frame.Size = UDim2.new(UDim.new(.15, 0), UDim.new(.1, 0))
	frame.Position = UDim2.new(UDim.new(1, 0), UDim.new(.45, 0))
	local bar = Instance.new("Frame")
	bar.Parent = frame
	bar.BorderSizePixel = 0
	bar.BackgroundColor3 = Color3.fromRGB(245, 205, 48)
	bar.Size = UDim2.new(UDim.new(1, 0), UDim.new(.175, 0))
	bar.Position = UDim2.new(UDim.new(0, 0), UDim.new(.83, 0))
	local label = Instance.new("TextLabel")
	label.Parent = frame
	label.BackgroundTransparency = 1
	label.Size = UDim2.new(UDim.new(.75, 0), UDim.new(.5, 0))
	label.Position = UDim2.new(UDim.new(.125, 0), UDim.new(.247, 0))
	label.TextStrokeColor3 = Color3.fromRGB(245, 205, 48)
	label.TextStrokeTransparency = 0
	label.TextColor3 = Color3.fromRGB(0, 0, 0)
	label.Text = "ReAnimation Script by Riptxde / R_ainCloud"
	label.TextScaled = true
	gui.Parent = game.CoreGui
	TService:Create(frame, TweenInfo.new(1, Enum.EasingStyle.Sine), {Position = UDim2.new(UDim.new(.425, 0), UDim.new(.45, 0))}):Play()
	wait(3)
	TService:Create(frame, TweenInfo.new(1, Enum.EasingStyle.Sine), {Position = UDim2.new(UDim.new(-.151, 0), UDim.new(.45, 	0))}):Play()
	wait(1)
	frame.Position = UDim2.new(UDim.new(1, 0), UDim.new(.45, 0))
	label.Text = "Edited by Andy Wirus"
	wait(2)
	TService:Create(frame, TweenInfo.new(1, Enum.EasingStyle.Sine), {Position = UDim2.new(UDim.new(.425, 0), UDim.new(.45, 0))}):Play()
	wait(3)
	TService:Create(frame, TweenInfo.new(1, Enum.EasingStyle.Sine), {Position = UDim2.new(UDim.new(-.151, 0), UDim.new(.45, 		0))}):Play()
